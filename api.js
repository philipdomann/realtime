...
(function() {
    var f = encodeURIComponent, g = window, k = decodeURIComponent, m = "push", n = "test", s = "shift", t = "replace", x = "length", A = "split", B = "join";
    ...
    S[m](["jsl", function(a) {
            ...
            if (b = a.u)
                a = F(I, "us", []), a[m](b), (b = /^https:(.*)$/.exec(b)) && a[m]("http:" + b[1])
        }]);
    var ha = /^(\/[a-zA-Z0-9_\-]+)+$/, ia = /^[a-zA-Z0-9\-_\.!]+$/, ja = /^gapi\.loaded_[0-9]+$/, ka = /^[a-zA-Z0-9,._-]+$/, oa = function(a, b, c, d) {
        var e = a[A](";"), h = R[e[s]()], l = null;
        h && (l = h(e, b, c, d));
        if (b = l)
            b = l, c = b.match(la), d = b.match(ma), b = !!d && 1 === d[x] && na[n](b) && !!c && 1 === c[x];
        b || T(a);
        return l
    }, qa = function(a, b, c, d) {
        a = pa(a);
    ...
    var W = decodeURI("%73cript"), X = function(a, b) {
        ...
        ta(a, c);
        var d = a ? a[A](":") : [], e = c.h || ra(), h = F(I, "ah", G());
        if (h["::"] && d[x]) {
            for (var l = [], p = null; p = d[s](); ) {
                var u = p[A]("."), u = h[p] || h[u[1] && "ns:" + u[0] || ""] || e, r = l[x] && l[l[x] - 1] || null, y = r;
                r && r.hint == u || (y = {hint: u, c: []}, l[m](y));
                y.c[m](p)
            }
            var z = l[x];
            if (1 < z) {
